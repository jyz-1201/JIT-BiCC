...
def main():
    ...
    # TODO: switch pre-training loading mechanism between multi-task and single-task
    ...
    # TODO: the lines below are only for debugging. Comment these lines before running the code
